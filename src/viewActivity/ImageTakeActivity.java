...
/*
 * This class we use to handle image upload functions.
 * 
 */
public class ImageTakeActivity extends Activity implements OnClickListener,
	 ...
	 * Make object to XML component  and bind necessary listeners.
	 * 
	 */
	@Override
	...
	/*
	 * This is a background process class. this handle image upload activity.
	 * 
	 */
	private class UploadTask extends AsyncTask<Bitmap, Void, Void> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ImageTakeActivity.this);
			pDialog.setMessage("Wait for uploading Image...!");
	 ...
	 * create image file as a binnary file.
	 *
	 */
	...
	/*
	 * Create a new directory in remote server to store a photo.
	 * this is a backgroun process.
	 * 
	 */
	...
	/*
	 * 
	 * location access code(non-Javadoc)
	 * @see android.location.LocationListener#onLocationChanged(android.location.Location)
	 * location access necessary methods.
	 * 
	 */
	@Override
