...
/*
 * This class handle all necessary activity to handle special user 
...
public class SpecialRegistor extends Activity {
	...
	private boolean valid_full_name;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// contact validation
		cont.addTextChangedListener(new PhoneNumberFormattingTextWatcher());
		...
		ok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Log.i("check ", !e_mail + " //" + fullnameString.equals(""));

				/*
				 * this code didn't work can't find error.so i put if-else
				 * ladder if( (fullnameString.equals("") &&
				 * depNoString.equals("") && depNameString.equals("") &&
				 * contectString.equals("") && !(e_mail) && addre.equals(""))){
				 * Toast.makeText(SpecialRegistor.this,
				...
				if (!(valid_full_name)) {
					Toast.makeText(SpecialRegistor.this,
							"please ,fill all necessary valid details",
							Toast.LENGTH_LONG).show();
				} else if (depNoString.equals("")) {
					Toast.makeText(SpecialRegistor.this,
							"please ,fill all necessary valid details",
							Toast.LENGTH_LONG).show();
				} else if (depNameString.equals("")) {
					Toast.makeText(SpecialRegistor.this,
							"please ,fill all necessary valid details",
							Toast.LENGTH_LONG).show();
				} else if (contectString.equals("")) {
					Toast.makeText(SpecialRegistor.this,
							"please ,fill all necessary valid details",
							Toast.LENGTH_LONG).show();
				} else if (!(e_mail)) {
		...
		cancel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (extras.getString("status").equalsIgnoreCase("notlogin")) {
					Intent blogin = new Intent(SpecialRegistor.this,
							LogIn.class);
					startActivity(blogin);
				} else {
					Intent bhome = new Intent(SpecialRegistor.this,
							HomePage.class);
	...
	// ==================valid full name field================
	public void Is_Valid_FullName(EditText edt) throws NumberFormatException {
	...
	/*
	 * this is a backgrounfd process handeler class.
	 * 
	 */
	class doSpecialRegister extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try { // add element to array list
				...
				JSONObject json = dbConnection.createHttpRequest(SPECIAL_URL,
						"POST", params);
				...
				if (success == 1) {
					if (!extras.getString("status")
							.equalsIgnoreCase("notlogin")) {

						Log.d("Send Registor Reuest Successful!",
								json.toString());
						Intent bhome = new Intent(SpecialRegistor.this,
								HomePage.class);
						bhome.putExtra("user_type", userType);
					...
					if (!extras.getString("status")
							.equalsIgnoreCase("notlogin")) {
						Intent logIntent = new Intent(SpecialRegistor.this,
								LogIn.class);
		...
		protected void onPostExecute(String result) {
			...
			dialogBox.dismiss();
			if (result != null) {
				Toast.makeText(SpecialRegistor.this, result, Toast.LENGTH_LONG)
						.show();
			}
