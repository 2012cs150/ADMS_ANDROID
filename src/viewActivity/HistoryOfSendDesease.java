...
/*
 * This class use to send diseases detail to server
 * 
 */
public class HistoryOfSendDesease extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Accept button activity.Bind on click listener to button.
		 */
		...
		/*
		 * Pending Button activity. Bind on click listener to button.
		 * 
		 */
		...
		/*
		 * Back Button activity.Bind onclick listener to back button
		 * 
		 */
		hback.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				//store necessary details in the Intent.
	...
	/*
	 * Async task to get all history details
	 * 
	 */
	 ...
	 * make this class to store the category detail
	 * }
	 */
	// ....................................................
