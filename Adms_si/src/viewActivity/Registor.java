...
public class Registor extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pPassword = (TextView) findViewById(R.id.txtPassword);
		pPassword.setTypeface(custom_font);
		
		cPassword= (TextView) findViewById(R.id.txtConfirmPassword);
		cPassword.setTypeface(custom_font);
		
		tcatogory = (TextView)findViewById(R.id.txtCategory);
		tcatogory.setTypeface(custom_font);
		...
		btnext.setTypeface(custom_font);
		btback = (Button) findViewById(R.id.btBack);
		btback.setTypeface(custom_font);
		...
		genrabtn.setTypeface(custom_font);
		specialrabtn.setTypeface(custom_font);
	...
	void getData() {
		...
		}else if (specialrabtn.isChecked()) {
