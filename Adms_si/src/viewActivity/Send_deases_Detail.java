...
public class Send_deases_Detail extends Activity {
	...
	private TextView tPlantName;
	private TextView tDeseaseType;
	private TextView tWeather;
	private TextView tSoilCondition;
	private TextView tDistrict;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Typeface custom_font = Typeface.createFromAsset(getAssets(),"fonts/kandyunicode.ttf");
		titleTV = (TextView)findViewById(R.id.txtTitle);
		titleTV.setTypeface(custom_font);
		
		tPlantName =(TextView)findViewById(R.id.txtPlantName);
		tPlantName.setTypeface(custom_font);
		tDeseaseType =(TextView)findViewById(R.id.txtDiseaseType);
		tDeseaseType.setTypeface(custom_font);
		tWeather =(TextView)findViewById(R.id.txtWeather);
		tWeather.setTypeface(custom_font);
		tSoilCondition=(TextView)findViewById(R.id.txtSoilCondition);
		tSoilCondition.setTypeface(custom_font);
		tDistrict=(TextView)findViewById(R.id.txtDistrict);
		tDistrict.setTypeface(custom_font);
		tRegion =(TextView)findViewById(R.id.txtRegion);
		tRegion.setTypeface(custom_font);
		tDiscription=(TextView)findViewById(R.id.txtDescription);
		tDiscription.setTypeface(custom_font);
		...
		sendDeseaseDetails.setTypeface(custom_font);
