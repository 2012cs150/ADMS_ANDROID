...
// OnItemSelectedListener
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txtHistory.setTypeface(custom_font);
		
		txtAccept=(TextView)findViewById(R.id.txtAccept);
		txtAccept.setTypeface(custom_font);
		
		txtPending=(TextView)findViewById(R.id.txtPending);
		txtPending.setTypeface(custom_font);
		...
		pending.setTypeface(custom_font);
		hback = (Button) findViewById(R.id.btnhBack);
		hback.setTypeface(custom_font);
