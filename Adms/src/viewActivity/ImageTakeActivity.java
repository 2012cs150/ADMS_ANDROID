...
public class ImageTakeActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.itback_button:	
			Intent diseDetailIntent = new Intent(ImageTakeActivity.this, Send_deases_Detail.class);
	...
	private class UploadTask extends AsyncTask<Bitmap, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			Toast.makeText(ImageTakeActivity.this, R.string.uploaded,Toast.LENGTH_LONG).show();
...
class makeDir extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try { // add first name, last name, Email & password to array list
				...
				params.add(new BasicNameValuePair("deases_id", Integer.toString(deases_id)));
				Log.i("post desese id",Integer.toString(deases_id));
				// getting product details by making HTTP request
				JSONObject json = dbConnection.createHttpRequest(UPload_Photo_URL,"POST", params);
